...
public class Employee {
    ...
    FileSystem createfolder = new FileSystem ("Employee.txt");
    ...
    public FileSystem getCategory() {
        return createfolder;
    }

    public void setCategory(FileSystem category) {
        this.createfolder = category;
    }
    ...
    public int addNewEmployee() {
        int noRows = 0;
        String employeeData = getEmployeeId()+ "," + getEmployeeName()+ "," + getEmployeeDepartment()+ "," 
                + getDesignations()+ ","
                + getEpfNumber()+ "\n";
